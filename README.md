...
- A scan of the data modeling diagram file is available as **[Data Modeling EmployeeSQL QuickDBD Diagram.png](https://github.com/aglantzrbc/sql-challenge/blob/main/EmployeeSQL_scan.png)**.
